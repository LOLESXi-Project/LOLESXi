...
<div class="graph-page">
  ...
  <main class="graph-app">
    <aside class="graph-sidebar">
      ...
      <div class="filter-group graph-loading" id="graph-loading">
      ...
      <div class="filter-group">
        ...
        <button id="view-procedure-map">
          Procedure map
          <span>Show procedures, ATT&amp;CK, detections and sources</span>
        </button>

        <button id="view-esxcli">
          Focus: esxcli
          <span>Show relationships around esxcli</span>
        </button>

        <button id="view-vim-cmd">
          Focus: vim-cmd
          <span>Show relationships around vim-cmd</span>
        </button>
      </div>
    ...
    <section class="graph-details" id="graph-details">
      <div class="detail-card">
        ...
        <h2>Loading graph</h2>
        <p>Loading data from the LOLESXi API.</p>
      </div>
    </section>
  </main>
</div>
